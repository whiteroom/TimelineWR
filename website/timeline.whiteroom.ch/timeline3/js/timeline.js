...
(() => {
    ...
    (() => {
        ...
        const A = (C = 0, I = "_tl_id", function(t) {
        ...
        const nt = function() {
            ...
            function C(t, e) {
                ...
                for (c && (a = e.left, s = e.top, delete e.right, delete e.bottom, delete e.left, delete e.top), i = n.length; i--;) {
                    ...
                    for (var L in e) {
                        ...
                        var C, I = v(n[i], L),
                            O = E(e[L]) ? e[L](n[i]) : e[L];
                        "string" != typeof O || !l.test(O) || l.test(I) ? (u[i][L] = "transform" == L ? k(I) : "string" == typeof O && l.test(O) ? T(I).slice(1) : parseFloat(I), m[i][L] = "transform" == L ? k(O, u[i][L]) : "string" == typeof O && "#" == O.charAt(0) ? T(O).slice(1) : A(O, parseFloat(I)), "string" == typeof O && (C = O.match(d)) && (_[i][L] = C[1])) : delete e[L]
                    }
                }
            ...
            return y((function(t) {
                o = t > 1e12 != s() > 1e12
            })), C.tween = D, C.getStyle = v, C.bezier = S, C.transform = f, C.parseTransform = k, C.formatTransform = x, C.easings = {}, C
        }();
        class ot {
            show(t) {
        ...
        var lt, ht = {
            ...
            dt = function() {
                ...
                function q(i, a, s) {
                    for (e in a) s && (R(a[e]) || S(a[e])) ? (R(a[e]) && !R(i[e]) && (i[e] = {}), S(a[e]) && !S(i[e]) && (i[e] = []), q(i[e], a[e], s)) : a[e] !== t && (i[e] = a[e])
                }
                ...
                return E.matches = function(t, e) {
                ...
                }, i.type = N, i.isFunction = A, i.isWindow = C, i.isArray = S, i.isPlainObject = R, i.isEmptyObject = function(t) {
                    var e;
                    for (e in t) return !1;
                    return !0
                    ...
                    closest: function(t, e) {
                        var a = this[0],
                            s = !1;
                        for ("object" == typeof t && (s = i(t)); a && !(s ? s.indexOf(a) >= 0 : E.matches(a, t));) a = a !== e && !I(a) && a.parentNode;
                        return i(a)
                    },
                    parents: function(t) {
        ...
        const ct = dt.getJSON,
            ...
            yt = it.extend({
                ...
                getDisplayDate: function(t, e) {
                    ...
                    t || (t = Nt.fallback), t.constructor != Nt && (S("First argument to getDisplayDate must be type Language"), t = Nt.fallback);
        ...
        const Lt = [
            ...
            Dt = yt.extend({
                ...
                getDisplayDate: function(t, e) {
                    if (this.data.display_date) return this.data.display_date;
                    var i = this.data.date_obj.getTime();
                    if (i >= -99999 && i <= 275759) {
                        var a = void 0 !== this.data.year ? this.data : {
                            year: i
                        };
                        return new yt(a).getDisplayDate(t, e)
                    }
                    t || (t = Nt.fallback), t.constructor != Nt && (t = Nt.fallback);
                    var s = e || this.data.format;
                    return t.formatDate(this.data.date_obj, s)
                },
                floor: function(t) {
        ...
        class Nt {
            ...
            mergeData(t) {
                for (k in It.en) t[k] && ("object" == typeof this[k] ? E(t[k], this[k]) : this[k] = t[k])
            }
            formatBigYear(t, e) {
                var i = t.year,
                ...
                return S("Language file dateformats missing cosmological. Falling back."), Ct(i, e)
            }
            _(t, e) {
        ...
        const ve = Yt(["a", "abbr", "acronym", "address", "area", "article", "aside", "audio", "b", "bdi", "bdo", "big", "blink", "blockquote", "body", "br", "button", "canvas", "caption", "center", "cite", "code", "col", "colgroup", "content", "data", "datalist", "dd", "decorator", "del", "details", "dfn", "dialog", "dir", "div", "dl", "dt", "element", "em", "fieldset", "figcaption", "figure", "font", "footer", "form", "h1", "h2", "h3", "h4", "h5", "h6", "head", "header", "hgroup", "hr", "html", "i", "img", "input", "ins", "kbd", "label", "legend", "li", "main", "map", "mark", "marquee", "menu", "menuitem", "meter", "nav", "nobr", "ol", "optgroup", "option", "output", "p", "picture", "pre", "progress", "q", "rp", "rt", "ruby", "s", "samp", "search", "section", "select", "shadow", "slot", "small", "source", "spacer", "span", "strike", "strong", "style", "sub", "summary", "sup", "table", "tbody", "td", "template", "textarea", "tfoot", "th", "thead", "time", "tr", "track", "tt", "u", "ul", "var", "video", "wbr"]),
            ...
            De = Yt(["xlink:href", "xml:id", "xlink:title", "xml:space", "xmlns:xlink"]),
            Se = Zt(/\{\{[\w\W]*|[\w\W]*\}\}/gm),
            Ne = Zt(/<%[\w\W]*|[\w\W]*%>/gm),
            Ae = Zt(/\$\{[\w\W]*/gm),
            Ce = Zt(/^data-[\-\w.\u00B7-\uFFFF]+$/),
            Ie = Zt(/^aria-[\-\w]+$/),
            Oe = Zt(/^(?:(?:(?:f|ht)tps?|mailto|tel|callto|sms|cid|xmpp|matrix):|[^a-z]|[a-z+.\-]+(?:[^a-z+.\-:]|$))/i),
        ...
        var qe = function t() {
            ...
            const i = e => t(e);
            if (i.version = "3.3.2", i.removed = [], !e || !e.document || 9 !== e.document.nodeType || !e.Element) return i.isSupported = !1, i;
            let {
                document: a
            } = e;
            const s = a,
            ...
            let G = !0,
                ...
                lt = {},
                ht = null;
            const dt = _e({}, ["annotation-xml", "audio", "colgroup", "desc", "foreignobject", "head", "iframe", "math", "mi", "mn", "mo", "ms", "mtext", "noembed", "noframes", "noscript", "plaintext", "script", "style", "svg", "template", "thead", "title", "video", "xmp"]);
            let ct = null;
            const ut = _e({}, ["audio", "video", "img", "source", "image", "track"]);
            let mt = null;
            const _t = _e({}, ["alt", "class", "for", "id", "label", "name", "pattern", "placeholder", "role", "summary", "title", "value", "style", "xmlns"]),
            ...
            let vt = gt,
                yt = !1,
                bt = null;
            const wt = _e({}, [pt, ft, gt], se);
            let kt = _e({}, ["mi", "mo", "mn", "ms", "mtext"]),
                xt = _e({}, ["annotation-xml"]);
            const Tt = _e({}, ["title", "style", "font", "a", "script"]);
            let Mt = null;
            ...
            const St = a.createElement("form"),
                ...
                At = function() {
                    ...
                    if (!Dt || Dt !== t) {
                        if (t && "object" == typeof t || (t = {}), t = fe(t), Mt = -1 === Et.indexOf(t.PARSER_MEDIA_TYPE) ? "text/html" : t.PARSER_MEDIA_TYPE, Lt = "application/xhtml+xml" === Mt ? se : ae, P = he(t, "ALLOWED_TAGS") ? _e({}, t.ALLOWED_TAGS, Lt) : H, F = he(t, "ALLOWED_ATTR") ? _e({}, t.ALLOWED_ATTR, Lt) : q, bt = he(t, "ALLOWED_NAMESPACES") ? _e({}, t.ALLOWED_NAMESPACES, se) : wt, mt = he(t, "ADD_URI_SAFE_ATTR") ? _e(fe(_t), t.ADD_URI_SAFE_ATTR, Lt) : _t, ct = he(t, "ADD_DATA_URI_TAGS") ? _e(fe(ut), t.ADD_DATA_URI_TAGS, Lt) : ut, ht = he(t, "FORBID_CONTENTS") ? _e({}, t.FORBID_CONTENTS, Lt) : dt, U = he(t, "FORBID_TAGS") ? _e({}, t.FORBID_TAGS, Lt) : fe({}), B = he(t, "FORBID_ATTR") ? _e({}, t.FORBID_ATTR, Lt) : fe({}), lt = !!he(t, "USE_PROFILES") && t.USE_PROFILES, G = !1 !== t.ALLOW_ARIA_ATTR, Y = !1 !== t.ALLOW_DATA_ATTR, Z = t.ALLOW_UNKNOWN_PROTOCOLS || !1, V = !1 !== t.ALLOW_SELF_CLOSE_IN_ATTR, X = t.SAFE_FOR_TEMPLATES || !1, J = !1 !== t.SAFE_FOR_XML, K = t.WHOLE_DOCUMENT || !1, et = t.RETURN_DOM || !1, it = t.RETURN_DOM_FRAGMENT || !1, at = t.RETURN_TRUSTED_TYPE || !1, tt = t.FORCE_BODY || !1, st = !1 !== t.SANITIZE_DOM, nt = t.SANITIZE_NAMED_PROPS || !1, ot = !1 !== t.KEEP_CONTENT, rt = t.IN_PLACE || !1, z = t.ALLOWED_URI_REGEXP || Oe, vt = t.NAMESPACE || gt, kt = t.MATHML_TEXT_INTEGRATION_POINTS || kt, xt = t.HTML_INTEGRATION_POINTS || xt, $ = t.CUSTOM_ELEMENT_HANDLING || {}, t.CUSTOM_ELEMENT_HANDLING && Nt(t.CUSTOM_ELEMENT_HANDLING.tagNameCheck) && ($.tagNameCheck = t.CUSTOM_ELEMENT_HANDLING.tagNameCheck), t.CUSTOM_ELEMENT_HANDLING && Nt(t.CUSTOM_ELEMENT_HANDLING.attributeNameCheck) && ($.attributeNameCheck = t.CUSTOM_ELEMENT_HANDLING.attributeNameCheck), t.CUSTOM_ELEMENT_HANDLING && "boolean" == typeof t.CUSTOM_ELEMENT_HANDLING.allowCustomizedBuiltInElements && ($.allowCustomizedBuiltInElements = t.CUSTOM_ELEMENT_HANDLING.allowCustomizedBuiltInElements), X && (Y = !1), it && (et = !0), lt && (P = _e({}, Te), F = Vt(null), !0 === lt.html && (_e(P, ve), _e(F, Me)), !0 === lt.svg && (_e(P, ye), _e(F, Ee), _e(F, De)), !0 === lt.svgFilters && (_e(P, be), _e(F, Ee), _e(F, De)), !0 === lt.mathMl && (_e(P, ke), _e(F, Le), _e(F, De))), he(t, "ADD_TAGS") || (W.tagCheck = null), he(t, "ADD_ATTR") || (W.attributeCheck = null), t.ADD_TAGS && ("function" == typeof t.ADD_TAGS ? W.tagCheck = t.ADD_TAGS : (P === H && (P = fe(P)), _e(P, t.ADD_TAGS, Lt))), t.ADD_ATTR && ("function" == typeof t.ADD_ATTR ? W.attributeCheck = t.ADD_ATTR : (F === q && (F = fe(F)), _e(F, t.ADD_ATTR, Lt))), t.ADD_URI_SAFE_ATTR && _e(mt, t.ADD_URI_SAFE_ATTR, Lt), t.FORBID_CONTENTS && (ht === dt && (ht = fe(ht)), _e(ht, t.FORBID_CONTENTS, Lt)), t.ADD_FORBID_CONTENTS && (ht === dt && (ht = fe(ht)), _e(ht, t.ADD_FORBID_CONTENTS, Lt)), ot && (P["#text"] = !0), K && _e(P, ["html", "head", "body"]), P.table && (_e(P, ["tbody"]), delete U.tbody), t.TRUSTED_TYPES_POLICY) {
                ...
                jt = function(t) {
                    ...
                    "application/xhtml+xml" === Mt && vt === gt && (t = '<html xmlns="http://www.w3.org/1999/xhtml"><head></head><body>' + t + "</body></html>");
                    const s = w ? w.createHTML(t) : t;
                    if (vt === gt) try {
                        e = (new m).parseFromString(s, Mt)
                    } catch (t) {}
                    if (!e || !e.documentElement) {
                        e = x.createDocument(vt, "template", null);
                        try {
                            e.documentElement.innerHTML = yt ? k : s
                        } catch (t) {}
                    }
                    const n = e.body || e.documentElement;
                    return t && i && n.insertBefore(a.createTextNode(i), n.childNodes[0] || null), vt === gt ? E.call(e, K ? "html" : "body")[0] : K ? e.documentElement : n
                },
                zt = function(t) {
            ...
            const qt = function(t) {
                    let e = null;
                    if (Ft(D.beforeSanitizeElements, t, null), Pt(t)) return Ot(t), !0;
                    const a = Lt(t.nodeName);
                    if (Ft(D.uponSanitizeElement, t, {
                            tagName: a,
                            allowedTags: P
                        }), J && t.hasChildNodes() && !Ht(t.firstElementChild) && de(/<[/\w!]/g, t.innerHTML) && de(/<[/\w!]/g, t.textContent)) return Ot(t), !0;
                    if (7 === t.nodeType) return Ot(t), !0;
                    if (J && 8 === t.nodeType && de(/<[/\w]/g, t.data)) return Ot(t), !0;
                    if (!(W.tagCheck instanceof Function && W.tagCheck(a)) && (!P[a] || U[a])) {
                        if (!U[a] && Bt(a)) {
                    ...
                    return t instanceof h && ! function(t) {
                        ...
                        const i = ae(t.tagName),
                            a = ae(e.tagName);
                        return !!bt[t.namespaceURI] && (t.namespaceURI === ft ? e.namespaceURI === gt ? "svg" === i : e.namespaceURI === pt ? "svg" === i && ("annotation-xml" === a || kt[a]) : Boolean(Ct[i]) : t.namespaceURI === pt ? e.namespaceURI === gt ? "math" === i : e.namespaceURI === ft ? "math" === i && xt[a] : Boolean(It[i]) : t.namespaceURI === gt ? !(e.namespaceURI === ft && !xt[a]) && !(e.namespaceURI === pt && !kt[a]) && !It[i] && (Tt[i] || !Ct[i]) : !("application/xhtml+xml" !== Mt || !bt[t.namespaceURI]))
                    }(t) ? (Ot(t), !0) : "noscript" !== a && "noembed" !== a && "noframes" !== a || !de(/<\/no(script|embed|frames)/i, t.innerHTML) ? (X && 3 === t.nodeType && (e = t.textContent, Kt([S, N, A], (t => {
                        e = oe(e, t, " ")
                    })), t.textContent !== e && (ee(i.removed, {
                        element: t.cloneNode()
                    }), t.textContent = e)), Ft(D.afterSanitizeElements, t, null), !1) : (Ot(t), !0)
                },
                Ut = function(t, e, i) {
                    if (B[e]) return !1;
                    if (st && ("id" === e || "name" === e) && (i in a || i in St)) return !1;
                    if (Y && !B[e] && de(C, e));
                    else if (G && de(I, e));
                    else if (W.attributeCheck instanceof Function && W.attributeCheck(e, t));
                    else if (!F[e] || B[e]) {
                        if (!(Bt(t) && ($.tagNameCheck instanceof RegExp && de($.tagNameCheck, t) || $.tagNameCheck instanceof Function && $.tagNameCheck(t)) && ($.attributeNameCheck instanceof RegExp && de($.attributeNameCheck, e) || $.attributeNameCheck instanceof Function && $.attributeNameCheck(e, t)) || "is" === e && $.allowCustomizedBuiltInElements && ($.tagNameCheck instanceof RegExp && de($.tagNameCheck, i) || $.tagNameCheck instanceof Function && $.tagNameCheck(i)))) return !1
                    } else if (mt[e]);
                    else if (de(z, oe(i, R, "")));
                    else if ("src" !== e && "xlink:href" !== e && "href" !== e || "script" === t || 0 !== re(i, "data:") || !ct[t])
                        if (Z && !de(O, oe(i, R, "")));
                        else if (i) return !1;
                    return !0
                },
                ...
                Wt = function(t) {
                    Ft(D.beforeSanitizeAttributes, t, null);
                    const {
                        attributes: e
                    } = t;
                    if (!e || Pt(t)) return;
                    ...
                    for (; s--;) {
                        const n = e[s],
                            ...
                            h = Lt(o),
                            d = l;
                        let c = "value" === o ? d : le(d);
                        if (a.attrName = h, a.attrValue = c, a.keepAttr = !0, a.forceKeepAttr = void 0, Ft(D.uponSanitizeAttribute, t, a), c = a.attrValue, !nt || "id" !== h && "name" !== h || (Rt(o, t), c = "user-content-" + c), J && de(/((--!?|])>)|<\/(style|script|title|xmp|textarea|noscript|iframe|noembed|noframes)/i, c)) {
                            Rt(o, t);
                            continue
                        }
                        if ("attributename" === h && ne(c, "href")) {
                            Rt(o, t);
                            continue
                        }
                        ...
                        const u = Lt(t.nodeName);
                        if (Ut(u, h, c)) {
                            if (w && "object" == typeof _ && "function" == typeof _.getAttributeType)
                                if (r);
                                else switch (_.getAttributeType(u, h)) {
                                    case "TrustedHTML":
                                        c = w.createHTML(c);
                                        break;
                            ...
                            if (c !== d) try {
                                r ? t.setAttributeNS(r, o, c) : t.setAttribute(o, c), Pt(t) ? Ot(t) : te(i.removed)
                            } catch (e) {
                                Rt(o, t)
                            }
                        } else Rt(o, t)
                    }
                    Ft(D.afterSanitizeAttributes, t, null)
                },
                Gt = function t(e) {
                    let i = null;
                    const a = zt(e);
                    for (Ft(D.beforeSanitizeShadowDOM, e, null); i = a.nextNode();) Ft(D.uponSanitizeShadowNode, i, null), qt(i), Wt(i), i.content instanceof o && t(i.content);
                    Ft(D.afterSanitizeShadowDOM, e, null)
                };
            return i.sanitize = function(t) {
                let e = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {},
                    ...
                    r = null,
                    h = null;
                if (yt = !t, yt && (t = "\x3c!--\x3e"), "string" != typeof t && !Ht(t)) {
                ...
                if (Q || At(e), i.removed = [], "string" == typeof t && (rt = !1), rt) {
                    if (t.nodeName) {
                        const e = Lt(t.nodeName);
                        if (!P[e] || U[e]) throw ce("root node is forbidden and cannot be sanitized in-place")
                    }
                } else if (t instanceof l) a = jt("\x3c!----\x3e"), n = a.ownerDocument.importNode(t, !0), 1 === n.nodeType && "BODY" === n.nodeName || "HTML" === n.nodeName ? a = n : a.appendChild(n);
                else {
                    if (!et && !X && !K && -1 === t.indexOf("<")) return w && at ? w.createHTML(t) : t;
                    if (a = jt(t), !a) return et ? null : at ? k : ""
                }
                a && tt && Ot(a.firstChild);
                const d = zt(rt ? t : a);
                for (; r = d.nextNode();) qt(r), Wt(r), r.content instanceof o && Gt(r.content);
                if (rt) return t;
                if (et) {
                    if (it)
                ...
                let c = K ? a.outerHTML : a.innerHTML;
                return K && P["!doctype"] && a.ownerDocument && a.ownerDocument.doctype && a.ownerDocument.doctype.name && de(ze, a.ownerDocument.doctype.name) && (c = "<!DOCTYPE " + a.ownerDocument.doctype.name + ">\n" + c), X && Kt([S, N, A], (t => {
                    c = oe(c, t, " ")
                })), w && at ? w.createHTML(c) : c
            }, i.setConfig = function() {
                At(arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {}), Q = !0
                ...
                "function" == typeof e && ee(D[t], e)
            }, i.removeHook = function(t, e) {
                if (void 0 !== e) {
                    const i = Qt(D[t], e);
                    return -1 === i ? void 0 : ie(D[t], i, 1)[0]
                }
                return te(D[t])
        ...
        function Ke(t) {
            ...
            return t.forEach(((t, i) => {
                try {
                    ...
                    if (a.constructor == x) e.errors.push(a);
                    else {
                        a.message && (a = a.message);
                        let s = t.Headline || i;
                        e.errors.push(a + `[${s}]`)
                    }
                }
        ...
        function ti(t, e) {
            const i = new Ge;
            "NetworkError" == t.name ? i.logError(new x("network_err")) : "TLError" == t.name ? i.logError(t) : i.logError(new x("unknown_read_err", t.name || t)), e(i)
        }

        function ei(t, e) {
            const i = new Ge(t);
            if (t.errors)
                for (let e = 0; e < t.errors.length; e++) i.logError(t.errors[e]);
            e(i)
        }
        class ii {
            constructor(t) {
        ...
        si("human", _t), si("cosmological", Lt);
        const ni = {
        ...
        class oi {
            ...
            getAxisTickDateFormat(t) {
                return "cosmological" == this._scale ? "compact" : ni[t]
            }
        }
        class ri {
            constructor(t) {
        ...
        class fi extends ci {
            _loadMedia() {
                ...
                this.youtube_loaded = !1, this._el.content_item = this.domCreate("div", "tl-media-item tl-media-youtube tl-media-shadow", this._el.content), this._el.content_item.id = z(7), t = function(t) {
                    ...
                    return s
                }(this.data.url), this.media_id = {}, this.data.url.match("v=") ? this.media_id.id = t.v : this.data.url.match("/embed/") ? this.media_id.id = this.data.url.split("embed/")[1].split(/[?&]/)[0] : this.data.url.match(/v\/|v=|youtu\.be\//) ? this.media_id.id = this.data.url.split(/v\/|v=|youtu\.be\//)[1].split(/[?&]/)[0] : S("YOUTUBE IN URL BUT NOT A VALID VIDEO"), this.data.url.match("start=") ? this.media_id.start = V(this.data.url.split("start=")[1]) : this.data.url.match("t=") && (this.media_id.start = V(this.data.url.split("t=")[1])), this.data.url.match("end=") && (this.media_id.end = V(this.data.url.split("end=")[1])), this.media_id.hd = Boolean(void 0 !== t.hd), mi("https://www.youtube.com/iframe_api", (function() {
                    e.createMedia()
                }))
            }
            _updateMediaDisplay() {
        ...
        class bi extends ci {
                    ...
                    this.establishMediaID(), t = `https://commons.wikimedia.org/w/api.php?action=query&titles=${this.media_id}&prop=imageinfo|entityterms&iiprop=url&&iiurlwidth=${e}&format=json&origin=*&wbetlanguage=${i}`, ct(t, (function(t) {
                        let e = function(t) {
                            ...
                            if (t.query && t.query.pages) {
                                ...
                                a.imageinfo && a.imageinfo[0] && (e.url = a.imageinfo[0].thumburl), a.entityterms && a.entityterms.label && (e.label = a.entityterms.label[0])
                            }
                            return console.log("processImageInfoAPIJSON"), console.log("JSON: ", t), console.log("response: ", e), e
                        }(t);
            ...
            createMedia() {
                ...
                this.data.title && (this._el.content_item.title = this.data.title), this._el.content_item.addEventListener("load", (function(e) {
                    ...
                    t.loadErrorDisplay(t._("wikipedia_image_load_err"))
        ...
        class wi extends ci {
            _loadMedia() {
                ...
                this._el.content_item = this.domCreate("div", "tl-media-item tl-media-iframe tl-media-soundcloud tl-media-shadow", this._el.content), this.media_id = this.data.url, t = "https://soundcloud.com/oembed?url=" + this.media_id + "&format=js&callback=?", ct(t, (function(t) {
                    mi("https://w.soundcloud.com/player/api.js", (function() {
                        e.createMedia(t)
                    }))
                }))
            }
        ...
        class Mi extends ci {
            ...
            createMedia(t) {
                var e, i, a, s = "",
                    ...
                    o = "",
                    r = this;
                n = t.html.split("</p>&mdash;")[0] + "</p></blockquote>", e = t.author_url.split("twitter.com/")[1], i = (o = t.html.split("</p>&mdash;")[1].split('<a href="')[1]).split('">')[0], a = o.split('">')[1].split("</a>")[0], (n = n.replace(/<a href/gi, '<a target="_blank" rel="noopener" href')).includes("pic.twitter.com") || n.includes("pic.x.com") ? (mi("https://platform.twitter.com/widgets.js", (function() {
        ...
        class Ei extends ci {
            ...
            createMedia(t) {
                var e, i, a, s = this,
                    ...
                    o = "",
                    r = "";
                o = t.html.split("</p>&mdash;")[0] + "</p></blockquote>", e = t.author_url.split("twitter.com/")[1], i = (r = t.html.split("</p>&mdash;")[1].split('<a href="')[1]).split('">')[0], a = r.split('">')[1].split("</a>")[0], o = o.replace(/<a href/gi, '<a target="_blank" rel="noopener" href');
                let l = this.media_id;
                o.includes("pic.twitter.com") ? twttr.ready((function(t) {
                    var e = String(l);
                    twttr.widgets.createTweet(e, s._el.content_item, {
                        conversation: "none",
                        linkColor: "#cc0000",
                        theme: "light"
                    }).then((function() {
                ...
                })) : (n += o, n += "<div class='vcard'>", n += "<a href='" + i + "' class='twitter-date' rel='noopener' target='_blank'>" + a + "</a>", n += "<div class='author'>", n += "<a class='screen-name url' href='" + t.author_url + "' rel='noopener' target='_blank'>", n += "<span class='avatar'></span>", n += "<span class='fn'>" + t.author_name + " <span class='tl-icon-twitter'></span></span>", n += "<span class='nickname'>@" + e + "<span class='thumbnail-inline'></span></span>", n += "</a>", n += "</div>", n += "</div>", this._el.content_item.innerHTML = n, this.onLoaded())
            }
            updateMediaDisplay() {}
            _updateMediaDisplay() {}
        }
        ...
        class Di extends ci {
            _loadMedia() {
                var t = this;
                this._el.content_item = this.domCreate("div", "tl-media-item tl-media-documentcloud tl-media-shadow", this._el.content), this._el.content_item.id = z(7), this.data.url.match(/\.html$/) ? this.data.url = this._transformURL(this.data.url) : this.data.url.match(/.(json|js)$/) || S("DOCUMENT CLOUD IN URL BUT INVALID SUFFIX"), mi(["https://assets.documentcloud.org/viewer/loader.js", "https://assets.documentcloud.org/viewer/viewer.js"], (function() {
                    t.createMedia()
                }))
            }
            _transformURL(t) {
        ...
        const Si = "https://graph.facebook.com/v8.0/instagram_oembed?access_token=704270473831239|830b21071290df4f81a35c56abbea096&fields=html,thumbnail_url,author_name&url=";
        ...
        class Ci extends ci {
            ...
            getImageURL() {
                ...
                mt(`${Si}${this.data.url}`).then((t => t.thumbnail_url)).catch((t => {
        ...
        class Ri extends ci {
            ...
            _updateMediaDisplay(t) {
                var e = this.options.height,
                    i = 0,
                    a = 0;
                e = h ? this.options.height / 2 : this.options.height - this.options.credit_height - this.options.caption_height - 30, this._el.content_item.style.maxHeight = "none", e > this.options.width ? (i = this.options.width + 80 + "px", a = this.options.width + "px") : (i = e + "px", a = e - 80 + "px"), this.player.style.width = a, this.player.style.height = i, this._el.credit && (this._el.credit.style.width = a), this._el.caption && (this._el.caption.style.width = a)
            }
            _stopMedia() {}
        }
        class ji extends ci {
        ...
        class zi extends ci {
            _loadMedia() {
                try {
                    ...
                    mi(["https://s.imgur.com/min/embed.js"], (function() {
                        t.createMedia()
                    }))
                } catch (t) {
        ...
        class $i extends ci {
            _loadMedia() {
                try {
                    var t = this.data.url.match(/tiktok\.com\/@([^\/]+)\/video\/(\d+)/);
                    if (!t || t.length < 3) return void this.loadErrorDisplay(this._("tiktok_invalidurl_err"));
                    this.username = t[1], this.media_id = t[2], this.clean_url = `https://www.tiktok.com/@${this.username}/video/${this.media_id}`, this.options.background || this.createMedia()
                } catch (t) {
            ...
            createMedia() {
                var t = this,
                    e = "https://www.tiktok.com/oembed?url=" + encodeURIComponent(this.clean_url);
                ut({
                    type: "GET",
                    url: e,
                    dataType: "json",
                    success: function(e) {
                        t.oembed_response = e, t._el.content_item = t.domCreate("div", "tl-media-item tl-media-tiktok", t._el.content), e.thumbnail_url ? (t._el.content_link = t.domCreate("a", "", t._el.content_item), t._el.content_link.href = t.clean_url, t._el.content_link.target = "_blank", t._el.content_link.setAttribute("rel", "noopener"), t._el.content_image = t.domCreate("img", "tl-media-image tl-media-shadow", t._el.content_link), t._el.content_image.src = e.thumbnail_url, t.data.alt ? t._el.content_image.alt = t.data.alt : e.title ? t._el.content_image.alt = q(e.title) : t._el.content_image.alt = "TikTok video by @" + t.username, t._el.play_overlay = t.domCreate("div", "tl-media-tiktok-play-overlay", t._el.content_link), t._el.play_icon = t.domCreate("span", "", t._el.play_overlay), t._el.content_image.addEventListener("load", (function(e) {
                            t.onMediaLoaded()
                        })), t.onLoaded(), t._getMeta()) : (t._el.content_item.innerHTML = e.html || "", t.onLoaded())
                    },
                    error: function(e, i) {
                        var a = t._("tiktok_invalidurl_err");
                        t.loadErrorDisplay(a)
                    }
                })
            }
            _updateMediaDisplay() {}
            _getMeta() {
                this.oembed_response && (this.oembed_response.author_name && (this.data.credit_alternate = `TikTok: <a href="https://www.tiktok.com/@${this.username}" target="_blank" rel="noopener">@${this.username}</a>`), this.oembed_response.title && (this.data.caption_alternate = this.oembed_response.title)), this.updateMeta()
            }
        }
        class Ui extends ci {
            _loadMedia() {
                try {
                    var t = this.data.url.match(/bsky\.app\/profile\/([^\/]+)\/post\/([^\/\?]+)/);
                    if (!t || t.length < 3) return void this.loadErrorDisplay(this._("bluesky_invalidurl_err"));
                    this.handle = t[1], this.post_id = t[2], this.clean_url = `https://bsky.app/profile/${this.handle}/post/${this.post_id}`, this.options.background || this.createMedia()
                } catch (t) {
            ...
            createMedia() {
                var t = this,
                    e = `at://${this.handle}/app.bsky.feed.post/${this.post_id}`,
                    i = `https://public.api.bsky.app/xrpc/app.bsky.feed.getPostThread?uri=${encodeURIComponent(e)}`;
                ut({
                    type: "GET",
                    url: i,
                    dataType: "json",
                    ...
                    error: function(e, i) {
                        t.loadErrorDisplay(t._("bluesky_invalidurl_err"))
                    }
                })
            }
            renderPost(t) {
                var e = this;
                if (t.thread && t.thread.post) {
                    var i = t.thread.post,
                        a = i.author,
                        s = i.record;
                    this._el.content_item = this.domCreate("div", "tl-media-item tl-media-bluesky", this._el.content), this._el.content_container.className = "tl-media-content-container";
                    var n = this.domCreate("div", "bluesky-post", this._el.content_item),
                        o = this.domCreate("div", "bluesky-author", n),
                        r = this.domCreate("a", "bluesky-author-link", o);
                    if (r.href = `https://bsky.app/profile/${a.handle}`, r.target = "_blank", r.setAttribute("rel", "noopener"), a.avatar) {
                        var l = this.domCreate("img", "bluesky-avatar", r);
                        l.src = a.avatar, l.alt = a.displayName || a.handle
                    }
                    if (this.domCreate("strong", "bluesky-display-name", r).innerHTML = (a.displayName || a.handle) + " <span class='tl-icon-bluesky'></span>", this.domCreate("span", "bluesky-handle", o).textContent = ` @${a.handle}`, s.text && (this.domCreate("div", "bluesky-text", n).textContent = s.text), i.embed && i.embed.images && i.embed.images.length > 0) {
                        var h = this.domCreate("div", "bluesky-images", n);
                        i.embed.images.forEach((function(t) {
                            var i = e.domCreate("img", "bluesky-image", h);
                            i.src = t.thumb || t.fullsize, i.alt = t.alt || ""
                        }))
                    }
                    if (i.embed && i.embed.record && i.embed.record.author) {
                        var d = this.domCreate("div", "bluesky-quote", n),
                            c = i.embed.record,
                            u = this.domCreate("div", "bluesky-quote-author", d);
                        if (c.author.avatar) {
                            var m = this.domCreate("img", "bluesky-avatar-small", u);
                            m.src = c.author.avatar, m.alt = c.author.displayName || c.author.handle
                        }
                        if (this.domCreate("strong", "", u).textContent = c.author.displayName || c.author.handle, this.domCreate("span", "bluesky-handle", u).textContent = ` @${c.author.handle}`, c.value && c.value.text && (this.domCreate("div", "bluesky-quote-text", d).textContent = c.value.text), c.embeds && c.embeds[0] && c.embeds[0].images) {
                            var _ = this.domCreate("div", "bluesky-quote-images", d);
                            c.embeds[0].images.forEach((function(t) {
                                var i = e.domCreate("img", "bluesky-image-small", _);
                                i.src = t.thumb || t.fullsize, i.alt = t.alt || ""
                            }))
                        }
                    }
                    var p = this.domCreate("div", "bluesky-link", n),
                        f = this.domCreate("a", "", p);
                    f.href = this.clean_url, f.target = "_blank", f.setAttribute("rel", "noopener"), f.textContent = "View on Bluesky", this.onLoaded()
                } else this.loadErrorDisplay(this._("bluesky_invalidurl_err"))
            }
            updateMediaDisplay() {}
            _updateMediaDisplay() {}
        }
            ...
            _initLayout() {
                if (this._el.container = v("div", "tl-timemarker"), this._el.container.setAttribute("tabindex", "-1"), this.data.unique_id && (this._el.container.id = this.data.unique_id + "-marker"), this.data.end_date && (this.has_end_date = !0, this._el.container.className = "tl-timemarker tl-timemarker-with-end"), this._el.timespan = v("div", "tl-timemarker-timespan", this._el.container), this._el.timespan_content = v("div", "tl-timemarker-timespan-content", this._el.timespan), this._el.content_container = v("div", "tl-timemarker-content-container", this._el.container), this._el.content = v("div", "tl-timemarker-content", this._el.content_container), this._el.line_left = v("div", "tl-timemarker-line-left", this._el.timespan), this._el.line_right = v("div", "tl-timemarker-line-right", this._el.timespan), this.data.media) {
                    ...
                    var t = {
                        ...
                        e = this.data.media.thumbnail ? Bi(t, !0) : null;
                    if (e) {
                        var i = new e.cls(t);
                        i.on("loaded", function() {
                            this._el.media = v("img", "tl-timemarker-media", this._el.media_container), this._el.media.src = i.getImageURL(), this._el.media.alt = ""
                        }.bind(this)), i.loadMedia()
                    } else {
                        var a = Bi(this.data.media).type;
        ...
        class Yi {
            ...
            _getTimeScale() {
                ...
                return 0 == t && (S("marker_height_min option must not be zero."), t = 30), this.max_rows = Math.round((this.options.height - this._el.timeaxis_background.offsetHeight - this.options.marker_padding) / t), this.max_rows < 1 && (this.max_rows = 1), new oi(this.config, {
            ...
            _createEras(t) {
                for (var e = 0; e < t.length; e++) {
                    var i = t[e],
                        a = new li(i.start_date, i.end_date, i.headline, this.options);
            ...
            _initLayout() {
                if (this._el.container = v("div", "tl-slide"), this.has.title && (this._el.container.className = "tl-slide tl-slide-titleslide"), this.data.unique_id && (this._el.container.id = this.data.unique_id), this._el.scroll_container = v("div", "tl-slide-scrollable-container", this._el.container), this._el.content_container = v("div", "tl-slide-content-container", this._el.scroll_container), this._el.content = v("div", "tl-slide-content", this._el.content_container), this._el.background = v("div", "tl-slide-background", this._el.container), this.data.background) {
                    if (this.data.background.url) {
                        var t = Bi(this.data.background, !0);
                ...
                this.data.media && this.data.media.url && "" != this.data.media.url && (this.has.media = !0), this.data.text && this.data.text.text && (this.has.text = !0), this.data.text && this.data.text.headline && (this.has.headline = !0), this.has.media && (this.data.media.mediatype = Bi(this.data.media), this.options.media_name = this.data.media.mediatype.name, this.options.media_type = this.data.media.mediatype.type, this.options.autolink = this.data.autolink, this._media = new this.data.media.mediatype.cls(this.data.media, this.options, this.getLanguage())), (this.has.text || this.has.headline) && (this._text = new di(this.data.text, {
        ...
        class Xi {
            ...
            _createSlide(t, e, i) {
                var a = new Zi(t, this.options, e, this.getLanguage());
        ...
        if (document) {
            ...
            t && t.length > 0 && (Ki = t[t.length - 1].src)
        }
        class Qi {
            constructor(t, e, i) {
                ...
                E(this.options, i), this.options.script_path || (this.options.script_path = this.determineScriptPath()), i.soundcite && this.on("ready", (() => {
                    S("Loading Soundcite resources "), _i("https://cdn.knightlab.com/libs/soundcite/latest/css/player.css"), mi("https://cdn.knightlab.com/libs/soundcite/latest/js/soundcite.min.js")
            ...
            _initData(t) {
                "string" == typeof t ? async function(t, e) {
                    ...
                    if (Je(t)) try {
                        console.log(`reading url ${t}`), ei(await Qe(t, a), i)
                    } catch (t) {
                        ti(t, i)
                    } else if (function(t) {
                            return /\.csv(\?.*)?$/i.test(t)
                        }(t)) try {
                        console.log(`reading CSV from url ${t}`);
                        ...
                        error: function(t, e) {
                            ti("parsererror" == e ? new x("invalid_url_err") : new x("unknown_read_err", e), i)
                        }
                    })
                }(t, {
                    callback: function(t) {
            ...
            _initLayout() {
                this.message.removeFrom(this._el.container), this._el.container.innerHTML = "", "top" == this.options.timenav_position ? (this._el.timenav = v("div", "tl-timenav", this._el.container), this._el.menubar = v("div", "tl-menubar", this._el.container), this._el.storyslider = v("div", "tl-storyslider", this._el.container)) : (this._el.storyslider = v("div", "tl-storyslider", this._el.container), this._el.timenav = v("div", "tl-timenav", this._el.container), this._el.menubar = v("div", "tl-menubar", this._el.container)), this._el.attribution = v("div", "tl-attribution", this._el.container), this._el.attribution.innerHTML = "<a href='https://timeline.knightlab.com' target='_blank' rel='noopener'><span class='tl-knightlab-logo'></span>TimelineJS</a>", this.options.width = this._el.container.offsetWidth, this.options.height = this._el.container.offsetHeight, this.options.timenav_height = this._calculateTimeNavHeight(this.options.timenav_height), this._timenav = new Yi(this._el.timenav, this.config, this.options, this.language), this._timenav.on("loaded", this._onTimeNavLoaded, this), this._timenav.options.height = this.options.timenav_height, this._timenav.init(), this.options.initial_zoom && this.setZoom(this.options.initial_zoom), this._storyslider = new Xi(this._el.storyslider, this.config, this.options, this.language), this._el.storyslider.setAttribute("role", "group"), this._el.storyslider.setAttribute("aria-label", this._("aria_label_timeline_content")), this._storyslider.on("loaded", this._onStorySliderLoaded, this), this._storyslider.init(), this._menubar = new Ji(this._el.menubar, this._el.container, this.options, this.getLanguage()), "portrait" == this.options.layout ? this.options.storyslider_height = this.options.height - this.options.timenav_height - 1 : this.options.storyslider_height = this.options.height - 1, this._updateDisplay()
            }
            _initEvents() {
            ...
            _initGoogleAnalytics(t) {
                mi(`https://www.googletagmanager.com/gtag/js?id=${t}`), window.dataLayer = window.dataLayer || [], window.gtag = function() {
        ...
        async function ta(t, e) {
            return e || (e = "https://sheets-proxy.knightlab.com/proxy/"), await Qe(t, {
                sheets_proxy: e
            })
        }
        R(Qi, Rt, at)
